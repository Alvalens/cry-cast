...
class Master extends Controller
{
        ...
        public function HitungSMA($table)
        {
            ...
            // Prepare the SQL query to get the low, high, and volume values from the master table in groups of 5
        ...
        public function Threshold($table)
        {
            ...
            // Prepare the SQL query to get the monthly averages of low, high, and volume from the master table
        ...
        // treshold check based on threshold table per month and iterate to chech per day in master table
        public function bayes($table)
        {
            ...
            foreach ($thresholds as $threshold) {
                ...
                // Get the master data for the month
    ...
    public function f1Score()
    {
        ...
        public function predict()
        {
            ...
            // count all data in table master and iterate
        ...
        public function importmaster(Request $request)
        {
            ...
            // get data as array from table master and column low and column id
            $low_data = DB::table($table)->select('low')->get();
            $low_trend = DB::table('SMA')->select('sma_low')->get();
    
            // get data as array from table master and column volume and column id
            ...
            // select high and low and volume from table master based on date
        ...
        {
            // minim date in table master
            $minDate = DB::table('master')->min('date');
            $maxDate = DB::table('master')->max('date');
            return view('menu.master', compact('minDate', 'maxDate'));
        }
    }
